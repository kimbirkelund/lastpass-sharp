...
namespace LastPass.Test
{
    ...
    class Pbkdf2Test
    {
        ...
        private readonly TestData[] _testData =
        {
            ...
            new TestData("passwordPASSWORDpassword", "saltSALTsaltSALTsaltSALTsaltSALTsalt", 4096,
        ...
        public void Generate_throws_on_zero_iterationCount()
        {
            Assert.Throws<ArgumentOutOfRangeException>(
                () => Pbkdf2.Generate(_testData[0].Password, _testData[0].Salt, 0,
                    _testData[0].Expected.Decode64().Length),
        ...
        {
            Assert.Throws<ArgumentOutOfRangeException>(
                () => Pbkdf2.Generate(_testData[0].Password, _testData[0].Salt, -1,
                    _testData[0].Expected.Decode64().Length),
                "Iteration count should be positive\r\nParameter name: iterationCount");
        }
